...
const CACHE = 'lcm-v91';
const ASSETS = ['./', 'index.html', 'style.css', 'app.js', 'ai.js', 'vendor/html2canvas.min.js', 'verify.html', 'demo.html', 'manifest.webmanifest', 'icons/icon-192.png', 'icons/icon-512.png'];
