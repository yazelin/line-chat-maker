...
const CACHE = 'lcm-v97';
const ASSETS = ['./', 'index.html', 'style.css', 'app.js', 'ai.js', 'vendor/html2canvas.min.js', 'vendor/mp4-muxer.min.js', 'verify.html', 'demo.html', 'manifest.webmanifest', 'icons/icon-192.png', 'icons/icon-512.png'];
