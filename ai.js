...
- 輸入框草稿:「(草稿) draft=打了沒送出的那句話」→ 顯示在輸入框;最強的結尾懸念武器
...
【創作憲章】以上規則只管格式,不管膽子——劇情要敢:誤會、反轉、翻車、告白、神來一筆的貼圖時機、最後一句停在草稿的懸念。平庸安全、只有寒暄問答的劇本會被評審退件;寧可戲劇化一點,也不要乾。五種訊息類型至少用三種,結構元素能用就用。
